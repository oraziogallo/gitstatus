...
function gitstatus_prompt_update() {
  ...
  local     branch=$'\001\e[38;5;003m\002'
  local      clean=$'\001\e[38;5;002m\002'
  local  untracked=$'\001\e[38;5;006m\002'
  local   modified=$'\001\e[38;5;001m\002'
  local conflicted=$'\001\e[38;5;001m\002'
  ...
  (( VCS_STATUS_NUM_STAGED     )) && p+=" ${branch}+${VCS_STATUS_NUM_STAGED}"
